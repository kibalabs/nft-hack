...
manager = MdtpManager(requester=requester, retriever=retriever, saver=saver, ethClient=ethClient, contractAddress='0x2744fE5e7776BCA0AF1CDEAF3bA3d1F5cae515d3', contractJson=contractJson)

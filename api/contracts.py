...
def create_contract_store(ethClient: EthClientInterface, rinkebyEthClient: EthClientInterface, mumbaiEthClient: EthClientInterface, accountAddress: Optional[str] = None, privateKey: Optional[str] = None) -> ContractStore:
    ...
    contractStore = ContractStore(accountAddress=accountAddress, privateKey=privateKey, contracts=[
        ...
        Contract(network='rinkeby6', address='0x8f1F643637046c867675Ca101ce28E2763daC1E2', abi=contract6Json, ethClient=rinkebyEthClient, metadataUriMethodName='tokenURI', tokenContentUriMethodName='tokenContentURI', ownerOfMethodName='ownerOf', totalSupplyMethodName='totalSupply', setTokenContentUriMethodName='setTokenContentURI', setTokenContentUriFieldName='contentURI', setTokenGroupContentUriMethodName='setTokenGroupContentURIs', transferTokenMethodName='transferFrom', mintTokenMethodName='mintToken', mintTokenGroupMethodName='mintTokenGroup', mintLimitMethodName='totalMintLimit', transferMethodSignature='Transfer(address,address,uint256)', updateMethodSignature='TokenContentURIChanged(uint256)'),
        Contract(network='mainnet1', address='0x1Cf33F4c6C4E6391F4D2B445aa3a36639b77dd68', abi=contract7Json, ethClient=ethClient, metadataUriMethodName='tokenURI', tokenContentUriMethodName='tokenContentURI', ownerOfMethodName='ownerOf', totalSupplyMethodName='totalSupply', setTokenContentUriMethodName='setTokenContentURI', setTokenContentUriFieldName='contentURI', setTokenGroupContentUriMethodName='setTokenGroupContentURIs', transferTokenMethodName='transferFrom', mintTokenMethodName='mintToken', mintTokenGroupMethodName='mintTokenGroup', mintLimitMethodName='totalMintLimit', transferMethodSignature='Transfer(address,address,uint256)', updateMethodSignature='TokenContentURIChanged(uint256)'),
        Contract(network='rinkeby7', address='0xcb784b2901D77e13981D87094AB54B7822b0D421', abi=contract8Json, ethClient=rinkebyEthClient, metadataUriMethodName='tokenURI', tokenContentUriMethodName='tokenContentURI', ownerOfMethodName='proxiedOwnerOf', totalSupplyMethodName='totalSupply', setTokenContentUriMethodName='setTokenContentURI', setTokenContentUriFieldName='contentURI', setTokenGroupContentUriMethodName='setTokenGroupContentURIs', transferTokenMethodName='transferFrom', mintTokenMethodName='mintToken', mintTokenGroupMethodName='mintTokenGroup', mintLimitMethodName='totalMintLimit', transferMethodSignature='Transfer(address,address,uint256)', updateMethodSignature='TokenContentURIChanged(uint256)'),
    ])

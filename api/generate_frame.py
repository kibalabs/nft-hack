...
def generate_svg(tokenId: int, colorConfig: ColorConfig) -> str:
    ...
    # How far a triangle can choose its color from 200 - 300
...
async def run():
    ...
    BLUE_COLOR_CONFIGS = [
        ...
        # light pink
        ColorConfig(colorPoints=generate_default_points("#4CC9F0", "#B96AC9"), shouldUseHslMerging=False),
        # dark green
    ...
    PINK_COLOR_CONFIGS = [
        # light grey
        ColorConfig(colorPoints=generate_default_points("#F72585", "#A3A3B7"), shouldUseHslMerging=False),
        # dark red
    ...
    GOLD_COLOR_CONFIGS = [
        # gold
        ColorConfig(colorPoints=generate_default_points("#FFD700", "#FFD700"), shouldUseHslMerging=False),
        # light grey
        ColorConfig(colorPoints=generate_default_points("#FFD700", "#A3A3B7"), shouldUseHslMerging=False),
        # black
    ...
    for tokenId, colorConfig in zip([1, 711, 3985, 6035, 6566, 8884], DARKBLUE_COLOR_CONFIGS):

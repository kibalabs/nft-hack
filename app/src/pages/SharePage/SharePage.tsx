...
export const SharePage = (): React.ReactElement => {
  ...
  const initialShareText = 'Fren, just found this site milliondollartokenpage.com where you can show your JPGs and own the space as an NFT. Probably nothing sers but gonna Ape in. WGMI! 🚀';

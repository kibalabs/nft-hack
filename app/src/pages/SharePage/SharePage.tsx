...
export const SharePage = (): React.ReactElement => {
  const initialShareText = 'Fren, just found this site milliondollartokenpage.com where you show off your JPGs and own the space as an NFT. Probably nothing fren but gonna Ape in. WGMI! 🚀';

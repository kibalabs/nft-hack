...
Today the internet is a lot more fun to play with and cryptocurrencies like [Bitcoin](https://bitcoin.org/en/faq) and [Ethereum](https://ethereum.org/en/what-is-ethereum/) have ushered in a new age known as [Web3](https://ethereum.org/en/developers/docs/web2-vs-web3/) where digitally native money and assets, represented by [tokens](https://blog.coinbase.com/a-beginners-guide-to-ethereum-tokens-fbd5611fe30b) and [NFTs](https://opensea.io/blog/guides/non-fungible-tokens/), can be transacted freely [P2P](https://www.investopedia.com/terms/p/peertopeer-p2p-service.asp) across the internet. Milliondollartokenpage infuses these modern innovations into the original idea to build a much more fun and functional place to share images and ads on anything you like!
...
And its a simple as that, buy as many pixels as you like and share your businesses, work or creations in this digital space with the entire world!
...
The first relates to the fact that when data is written into the Ethereum blockchain its made [immutable](https://academy.binance.com/en/glossary/immutability). So even if one day the milliondollartokenpage servers topple over, you the sole owner of the NFT representing this block of pixels will still have ownership and it will still point to the same data. So another developer could potentially build an identical website showing the same exact images and links as before and your pixels would still show up identically as before.
